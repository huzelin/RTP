// Parse the Configure in google::protobuf
//
#ifndef COMMON_CONFIG_PROTO_CONFIGURE_H_
#define COMMON_CONFIG_PROTO_CONFIGURE_H_
...
class ProtoConfigure {
 public:
  ProtoConfigure() : type_name_(), conf_name_(), config_(NULL) { }
  ProtoConfigure(const std::string& type_name, const std::string& conf_name)
    : type_name_(), conf_name_(), config_(NULL) { Init(type_name, conf_name); }
...
#endif  // COMMON_CONFIG_PROTO_CONFIGURE_H_
