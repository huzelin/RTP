...
set(PROTOBUF_INCLUDE_DIR ${PROJECT_SOURCE_DIR}/3rdparty/protobuf/protobuf-3.6.0/include/)
set(PROTOBUF_PROTOC_EXECUTABLE ${PROJECT_SOURCE_DIR}/3rdparty/protobuf/protobuf-3.6.0/bin/protoc)
set(PROTOBUF_LIBRARIES ${PROJECT_SOURCE_DIR}/3rdparty/protobuf/protobuf-3.6.0/lib64)
set(PROTOBUF_IMPORT_DIRS
  ${PROJECT_SOURCE_DIR}/3rdparty/protobuf/protobuf-3.6.0/include/
)
find_package(Protobuf REQUIRED)
include_directories(
  ${PROJECT_SOURCE_DIR}/3rdparty/protobuf/protobuf-3.6.0/include/
)
set(grpc_cpp_plugin_path ${PROJECT_SOURCE_DIR}/3rdparty/protobuf/protobuf-3.6.0/bin/grpc_cpp_plugin)
...
# Modification of standard 'protobuf_generate_cpp()' with output dir parameter and python support
# Usage:
#   protobuf_generate_grpc_cpp_py(<output_dir> <srcs_var> <hdrs_var> <python_var> <proto_files>)
function(protobuf_generate_grpc_cpp_py output_dir srcs_var hdrs_var python_var work_path proto_path)
  if(NOT ARGN)
    message(SEND_ERROR "Error: protobuf_generate_cpp_py() called without any proto files")
    return()
  endif()
...
# Modification of standard 'protobuf_generate_cpp()' with output dir parameter and python support
# Usage:
#   protobuf_generate_brpc_cpp_py(<output_dir> <srcs_var> <hdrs_var> <python_var> <proto_files>)
function(protobuf_generate_brpc_cpp_py output_dir srcs_var hdrs_var python_var work_path proto_path)
  if(NOT ARGN)
    message(SEND_ERROR "Error: protobuf_generate_cpp_py() called without any proto files")
    return()
  endif()
